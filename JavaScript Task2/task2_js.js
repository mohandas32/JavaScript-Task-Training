...
function addRowContent() {
    ...
    newCell2.innerHTML = `<input type="text"  class="form-control stu_name" pattern="[A-Za-z\s]{3,15}" title="Only alphabets allowed" placeholder="Enter Name" required>`
    newCell3.innerHTML = `<input type="text"  class="form-control subject" pattern="[A-Za-z\s]{3,20}" title="Only alphabets allowed" placeholder="Enter Subject" required>`
    ...
    newCell6.innerHTML = `<button class="fail btn btn-outline-danger" onclick="removeRowContent(this)">Remove </button>`
    srCounter++
}
